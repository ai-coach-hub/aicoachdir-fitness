import {
  buildBackfillCorsHeaders,
  handleWorkoutBridgeBackfill,
} from '../backfill-route-core.mjs';
...
export async function OPTIONS(request) {
  ...
  return new Response(null, {
    status: 204,
    headers: buildBackfillCorsHeaders(origin, origins),
  });
}

export async function POST(request) {
  return handleWorkoutBridgeBackfill({
    request,
